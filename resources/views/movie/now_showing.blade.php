            ...
            @foreach($movies as $movie)
                <div class="movie-card">
                    ...
                    <div class="movie-info">
                        ...
                        <p class="movie-description">{{ Str::limit($movie->description ?? 'Experience this amazing film in theaters now.', 100) }}</p>
                        
                        <div class="movie-actions">
                            <a href="/movies/{{ $movie->id }}" class="movie-btn movie-btn-primary">View Details</a>
                            <a href="{{ route('movies.showtimes', ['id' => $movie->id]) }}" class="movie-btn movie-btn-secondary">Book Now</a>
                        </div>
                    </div>
                </div>
            @endforeach
