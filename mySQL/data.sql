...
(8, 3, 2, 'Didn’t get the hype.', NOW(), NOW()),
...
(8, 5, 2, 'Didn’t like the Joker.', NOW(), NOW()),
...
(14, 6, 1, 'Didn’t finish the movie.', NOW(), NOW()),
...
(8, 7, 2, 'Didn’t like the ending.', NOW(), NOW()),
...
(8, 8, 2, 'Didn’t get the story.', NOW(), NOW()),
...
(8, 9, 2, 'Didn’t like the fantasy.', NOW(), NOW()),
...
(9, 10, 1, 'Didn’t enjoy it.', NOW(), NOW()),
...
(13, 11, 2, 'Didn’t like the characters.', NOW(), NOW()),
...
(14, 12, 1, 'Didn’t like it.', NOW(), NOW()),
...
(14, 14, 1, 'Didn’t enjoy it.', NOW(), NOW()),
...
(7, 15, 3, 'Good, but not scary.', NOW(), NOW()),
(8, 15, 2, 'Too emotional.', NOW(), NOW()),
(9, 15, 1, 'Not a fan of zombies.', NOW(), NOW()),
(10, 15, 5, 'Very emotional.', NOW(), NOW()),
(11, 15, 4, 'Loved the suspense.', NOW(), NOW()),
(12, 15, 3, 'Average action.', NOW(), NOW()),
(13, 15, 2, 'Too much drama.', NOW(), NOW()),
(14, 15, 1, 'Boring.', NOW(), NOW()),
...
(4, 1, '2026-01-23', '13:30:00'),
(5, 1, '2026-01-23', '16:30:00'),
(6, 1, '2026-01-23', '19:30:00'),
(7, 1, '2026-01-23', '22:15:00'),

(8, 2, '2026-01-23', '10:00:00'),
(9, 2, '2026-01-23', '13:30:00'),
(10, 2, '2026-01-23', '16:30:00'),
(11, 2, '2026-01-23', '19:30:00'),
(12, 2, '2026-01-23', '22:15:00'),

(13, 3, '2026-01-23', '10:00:00'),
(14, 3, '2026-01-23', '13:30:00'),
(15, 3, '2026-01-23', '16:30:00'),
(3, 3, '2026-01-23', '19:30:00'),
(4, 3, '2026-01-23', '22:15:00'),

(5, 4, '2026-01-23', '10:00:00'),
(6, 4, '2026-01-23', '13:30:00'),
(7, 4, '2026-01-23', '16:30:00'),
(8, 4, '2026-01-23', '19:30:00'),
(9, 4, '2026-01-23', '22:15:00'),

-- ================== 2026-01-24 ==================
(4, 1, '2026-01-24', '10:00:00'),
(5, 1, '2026-01-24', '13:30:00'),
(6, 1, '2026-01-24', '16:30:00'),
(7, 1, '2026-01-24', '19:30:00'),
(3, 1, '2026-01-24', '22:15:00'),

(9, 2, '2026-01-24', '10:00:00'),
(10, 2, '2026-01-24', '13:30:00'),
(11, 2, '2026-01-24', '16:30:00'),
(12, 2, '2026-01-24', '19:30:00'),
(8, 2, '2026-01-24', '22:15:00'),

(14, 3, '2026-01-24', '10:00:00'),
(15, 3, '2026-01-24', '13:30:00'),
(3, 3, '2026-01-24', '16:30:00'),
(4, 3, '2026-01-24', '19:30:00'),
(13, 3, '2026-01-24', '22:15:00'),

(6, 4, '2026-01-24', '10:00:00'),
(7, 4, '2026-01-24', '13:30:00'),
(8, 4, '2026-01-24', '16:30:00'),
(9, 4, '2026-01-24', '19:30:00'),
(5, 4, '2026-01-24', '22:15:00'),

-- ================== 2026-01-25 ==================
(5, 1, '2026-01-25', '10:00:00'),
(6, 1, '2026-01-25', '13:30:00'),
(7, 1, '2026-01-25', '16:30:00'),
(3, 1, '2026-01-25', '19:30:00'),
(4, 1, '2026-01-25', '22:15:00'),

(10, 2, '2026-01-25', '10:00:00'),
(11, 2, '2026-01-25', '13:30:00'),
(12, 2, '2026-01-25', '16:30:00'),
(8, 2, '2026-01-25', '19:30:00'),
(9, 2, '2026-01-25', '22:15:00'),

(15, 3, '2026-01-25', '10:00:00'),
(3, 3, '2026-01-25', '13:30:00'),
(4, 3, '2026-01-25', '16:30:00'),
(13, 3, '2026-01-25', '19:30:00'),
(14, 3, '2026-01-25', '22:15:00'),

(7, 4, '2026-01-25', '10:00:00'),
(8, 4, '2026-01-25', '13:30:00'),
(9, 4, '2026-01-25', '16:30:00'),
...
-- Each movie has 3-5 showtimes across different rooms and dates

INSERT INTO showtimes (movie_id, room_id, show_date, show_time) VALUES
-- Movie 1: Avengers: Endgame (181 min)
(1, 1, '2026-01-29', '10:00:00'),
(1, 3, '2026-01-29', '14:30:00'),
(1, 4, '2026-01-30', '13:00:00'),
(1, 2, '2026-01-31', '19:00:00'),
(1, 4, '2026-02-01', '16:00:00'),

-- Movie 2: John Wick: Chapter 4 (169 min)
(2, 2, '2026-01-29', '11:00:00'),
(2, 4, '2026-01-29', '18:00:00'),
(2, 1, '2026-01-30', '15:00:00'),
(2, 3, '2026-01-31', '20:00:00'),
(2, 2, '2026-02-01', '14:00:00'),

-- Movie 3: Parasite (132 min)
(3, 3, '2026-01-29', '10:30:00'),
(3, 1, '2026-01-30', '13:30:00'),
(3, 4, '2026-01-30', '19:30:00'),
(3, 2, '2026-01-31', '16:00:00'),

-- Movie 4: Train to Busan (118 min)
(4, 1, '2026-01-29', '14:00:00'),
(4, 4, '2026-01-29', '21:00:00'),
(4, 3, '2026-01-30', '17:00:00'),
(4, 2, '2026-01-31', '11:00:00'),
(4, 1, '2026-02-01', '20:00:00'),

-- Movie 5: The Dark Knight (152 min)
(5, 2, '2026-01-29', '15:00:00'),
(5, 4, '2026-01-30', '10:00:00'),
(5, 1, '2026-01-31', '14:00:00'),
(5, 3, '2026-02-01', '19:00:00'),

-- Movie 6: Avatar (162 min)
(6, 4, '2026-01-29', '10:00:00'),
(6, 3, '2026-01-29', '17:30:00'),
(6, 1, '2026-01-30', '19:00:00'),
(6, 4, '2026-01-31', '14:00:00'),
(6, 2, '2026-02-01', '10:30:00'),

-- Movie 7: La La Land (128 min)
(7, 1, '2026-01-29', '17:30:00'),
(7, 2, '2026-01-30', '10:00:00'),
(7, 3, '2026-01-31', '13:00:00'),
(7, 1, '2026-02-01', '16:30:00'),

-- Movie 8: Your Name (112 min)
(8, 3, '2026-01-29', '13:00:00'),
(8, 2, '2026-01-29', '19:00:00'),
(8, 1, '2026-01-30', '10:00:00'),
(8, 4, '2026-01-31', '17:30:00'),
(8, 3, '2026-02-01', '11:00:00'),

-- Movie 9: Spirited Away (125 min)
(9, 1, '2026-01-29', '20:30:00'),
(9, 4, '2026-01-30', '16:00:00'),
(9, 2, '2026-01-31', '13:30:00'),
(9, 3, '2026-02-01', '14:00:00'),

-- Movie 10: Intouchables (112 min)
(10, 2, '2026-01-29', '13:00:00'),
(10, 1, '2026-01-30', '16:30:00'),
(10, 3, '2026-01-31', '10:00:00'),
(10, 4, '2026-02-01', '19:00:00'),

-- Movie 11: Toy Story (81 min)
(11, 3, '2026-01-29', '09:00:00'),
(11, 1, '2026-01-29', '12:00:00'),
(11, 2, '2026-01-30', '13:00:00'),
(11, 4, '2026-01-31', '10:30:00'),
(11, 1, '2026-02-01', '09:30:00'),

-- Movie 12: The Conjuring (112 min)
(12, 4, '2026-01-29', '22:00:00'),
(12, 2, '2026-01-30', '21:00:00'),
(12, 3, '2026-01-31', '22:00:00'),
(12, 1, '2026-02-01', '21:30:00'),

-- Movie 13: Furie (98 min)
(13, 1, '2026-01-29', '15:30:00'),
(13, 3, '2026-01-30', '10:30:00'),
(13, 2, '2026-01-30', '18:00:00'),
(13, 4, '2026-01-31', '20:30:00'),
(13, 1, '2026-02-01', '13:00:00'),

-- Movie 14: Forrest Gump (142 min)
(14, 2, '2026-01-29', '09:30:00'),
(14, 4, '2026-01-30', '13:30:00'),
(14, 1, '2026-01-31', '10:00:00'),
(14, 3, '2026-02-01', '16:30:00'),

-- Movie 15: Train to Busan (duplicate - 118 min)
