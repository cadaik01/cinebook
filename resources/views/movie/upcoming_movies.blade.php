                    ...
                    <div class="movie-info">
                        ...
                        <div class="movie-meta">
                            ...
                            @if($movie->release_date)
                                <span class="release-date">📅 {{ \Carbon\Carbon::parse($movie->release_date)->format('M d, Y') }}</span>
                            @endif
                        </div>
                        ...
                        <p class="movie-description">{{ Str::limit($movie->description ?? 'Get ready for this exciting upcoming film!', 100) }}</p>
