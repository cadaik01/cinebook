        ...
        <div class="content">
            ...
            <div class="details-section">
                ...
                <div class="detail-row">
                    ...
                    <span class="detail-value">{{ \Carbon\Carbon::parse($booking->showtime->show_date)->format('l, F d, Y') }}</span>
                </div>

                <div class="detail-row">
                    <span class="detail-label">Show Time:</span>
                    <span class="detail-value">{{ \Carbon\Carbon::parse($booking->showtime->show_time)->format('h:i A') }}</span>
                </div>
                ...
                <div class="detail-row">
                    ...
                    <span class="detail-value">{{ $booking->bookingSeats->map(fn($s) => $s->seat->seat_code)->join(', ') }}</span>
                </div>

                <div class="detail-row">
                    <span class="detail-label">Original Amount:</span>
                    <span class="detail-value"><strong>${{ number_format($booking->total_price / 1000, 2) }} USD</strong></span>
                </div>
            </div>
            ...
            <div class="refund-section">
                ...
                <p>Refund Amount: <span class="refund-amount">${{ number_format($refundAmount / 1000, 2) }} USD</span></p>
                <p class="refund-note">
